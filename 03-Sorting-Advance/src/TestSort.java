...
public class TestSort {
	...
	public static void main(String[] args) throws Exception {
		...
		int n = 10000;
		//选择排序
		testSort(n,"SelectionSort", "selectionSort");
		//插入排序
		testSort(n,"InsertionSort", "insertionSort");
		//插入排序优化版
		testSort(n,"InsertionSort", "insertionSortOptimization");
		//冒泡排序
		testSort(n,"BubbleSort", "bubbleSort");
		//归并排序自底向上
		testSort(n,"MergeSortBU", "mergeSort");
		//归并排序自顶向下
		testSort(n,"MergeSortUB", "mergeSort");
		//快速排序
		testSort(n,"QuickSort", "quickSort");
		//三路快速排序
		testSort(n,"QuickSort3Ways", "quickSort3Ways");
	}
